...
1. **Validate the epic**: The epic ID has been provided. Validate it exists and get the tasks:
   ```bash
...
```
[Getting Started]
Coordinator: Validates epic exists via bd show <epic-id> --json
Coordinator: Shows 7 tasks
