...
// ParseEvent parses a JSON line from Codex's --json output into a client.OutputEvent.
...
// TODO: If reasoning events become needed in the future, add EventType for them.
